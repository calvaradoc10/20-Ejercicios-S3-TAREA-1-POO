...
class CalculadorDistancia:
    ...
    def punto_mas_cercano(self, referencia, *puntos):
        ...
        for punto in puntos:
            d = self.distancia_euclidiana(referencia, punto)   # REUTILIZACION
            if d < minima:
                minima = d
                cercano = punto
        return cercano
...
if __name__ == "__main__":
    ...
    print("distancia (0,0)-(3,4) ->", cd.distancia_euclidiana((0, 0), (3, 4)))
...
#   p1 = (0,0) -> x1 = 0, y1 = 0     <- desempaquetado de tuplas
#   p2 = (3,4) -> x2 = 3, y2 = 4
#   dx = 3 - 0 = 3     dy = 4 - 0 = 4
#   3**2 + 4**2 = 9 + 16 = 25
#   raiz de 25 = 5.0
